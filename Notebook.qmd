...
# Join the data_geral_filtrado_b3, data_ativo_passivo and complemento_data tables

data_geral_filtrado_b3 <- data_geral_filtrado_b3 %>%
    left_join(data_ativo_passivo, by = "CNPJ_Fundo") %>%
